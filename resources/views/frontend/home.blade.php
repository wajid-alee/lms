      ...
      <div class="row justify-content-between">
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="0">
          <figure class="img-wrap-2">
            <img src="frontend/images/teacher-min.jpg" alt="Image" class="img-fluid">
  ...
  <div class="untree_co-section pt-0 bg-img overlay" style="background-image: url('frontend/images/img-school-1-min.jpg');">
    <div class="container">
      ...
      <div class="row justify-content-between">
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
          ...
          <a href="https://vimeo.com/342333493" data-fancybox class="video-wrap">
            ...
            <img src="frontend/images/img-school-4-min.jpg" alt="Image" class="img-fluid rounded">
          </a>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-5 mr-auto mb-5 mb-lg-0"  data-aos="fade-up" data-aos-delay="0">
          <img src="frontend/images/img-school-5-min.jpg" alt="image" class="img-fluid">
        </div>
